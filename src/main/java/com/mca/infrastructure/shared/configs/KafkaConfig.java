package com.mca.infrastructure.shared.configs;

import com.mca.infrastructure.shared.eventbuses.KafkaEventBus;
...
public class KafkaConfig implements CommandLineRunner {
	@Autowired
	KafkaEventBus kafkaMessageProducer;
	...
	public void run(String... args) throws Exception {
		try {
			List<UpdateStockEvent> stocks = Files
	...
	public UpdateStockEvent convertStock(List<String> stock) {
		return UpdateStockEvent.builder().stock_id(Long.parseLong(stock.get(0)))
